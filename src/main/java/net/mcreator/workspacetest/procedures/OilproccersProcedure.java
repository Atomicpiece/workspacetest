...
public class OilproccersProcedure {
	public static void execute(LevelAccessor world, double x, double y, double z) {
		if ((world.getBlockState(BlockPos.containing(x, y - 1, z))).getBlock() == WorkspaceTestModBlocks.CRUDEOILDE.get() && (new Object() {
			...
			}
			{
				...
				if (_ent != null) {
					final int _slotid = 0;
					final ItemStack _setstack = new ItemStack(WorkspaceTestModItems.CRUDEOILBARREL.get());
			...
			WorkspaceTestMod.queueServerWork((int) (20 / (new Object() {
				...
				PumpstartProcedure.execute(world, x, y, z);
			});
		} else {
			if (!world.isClientSide()) {
				BlockPos _bp = BlockPos.containing(x, y, z);
