...
public class ReactorGUIMenu extends AbstractContainerMenu implements Supplier<Map<Integer, Slot>> {
	...
	public ReactorGUIMenu(int id, Inventory inv, FriendlyByteBuf extraData) {
		super(WorkspaceTestModMenus.REACTOR_GUI.get(), id);
