...
import net.mcreator.workspacetest.item.TungsteningotItem;
import net.mcreator.workspacetest.item.TungstenchunkItem;
import net.mcreator.workspacetest.item.TitaniumingotItem;
...
import net.mcreator.workspacetest.item.LithiumcubeItem;
import net.mcreator.workspacetest.item.LithiumItem;
import net.mcreator.workspacetest.item.LithchunkItem;
import net.mcreator.workspacetest.item.LeadingotItem;
import net.mcreator.workspacetest.item.LeadchunkItem;
import net.mcreator.workspacetest.item.IroningotItem;
...
import net.mcreator.workspacetest.item.HazmatsuitItem;
...
public class WorkspaceTestModItems {
	...
	public static final RegistryObject<Item> IRONINGOT = REGISTRY.register("ironingot", () -> new IroningotItem());
	public static final RegistryObject<Item> URANINGOT = REGISTRY.register("uraningot", () -> new UraningotItem());
	public static final RegistryObject<Item> LITHIUMCUBE = REGISTRY.register("lithiumcube", () -> new LithiumcubeItem());
	public static final RegistryObject<Item> THORIUMINGOT = REGISTRY.register("thoriumingot", () -> new ThoriumingotItem());
	...
	public static final RegistryObject<Item> GOLDCUBE = REGISTRY.register("goldcube", () -> new GoldcubeItem());
	public static final RegistryObject<Item> COPPERCUBE = REGISTRY.register("coppercube", () -> new CoppercubeItem());
