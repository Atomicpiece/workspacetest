...
public class CoalguiSlotMessage {
	...
	public CoalguiSlotMessage(FriendlyByteBuf buffer) {
	...
	public static void buffer(CoalguiSlotMessage message, FriendlyByteBuf buffer) {
	...
	public static void handler(CoalguiSlotMessage message, Supplier<NetworkEvent.Context> contextSupplier) {
