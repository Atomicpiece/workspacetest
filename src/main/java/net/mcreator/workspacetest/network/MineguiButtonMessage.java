...
public class MineguiButtonMessage {
	...
	public MineguiButtonMessage(int buttonID, int x, int y, int z) {
	...
	public static void buffer(MineguiButtonMessage message, FriendlyByteBuf buffer) {
	...
	public static void handler(MineguiButtonMessage message, Supplier<NetworkEvent.Context> contextSupplier) {
