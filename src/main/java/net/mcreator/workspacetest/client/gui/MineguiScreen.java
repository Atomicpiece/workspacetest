...
public class MineguiScreen extends AbstractContainerScreen<MineguiMenu> {
	...
	protected void renderLabels(GuiGraphics guiGraphics, int mouseX, int mouseY) {
		...
		guiGraphics.drawString(this.font, Component.translatable("gui.workspace_test.minegui.label_output"), 150, 60, -12829636, false);
		guiGraphics.drawString(this.font, Component.translatable("gui.workspace_test.minegui.label_power_usage"), 81, 73, -12829636, false);
		...
		guiGraphics.drawString(this.font,
				...
				MinepowerusageProcedure.execute(), 150, 73, -12829636, false);
		guiGraphics.drawString(this.font,
		...
		guiGraphics.drawString(this.font,
				...
				MineproccesProcedure.execute(), 58, 29, -12829636, false);
	}
