...
public class WaterCannonEntity extends PathfinderMob implements GeoEntity {
	...
	public WaterCannonEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(WorkspaceTestModEntities.WATER_CANNON.get(), world);
	}

	public WaterCannonEntity(EntityType<WaterCannonEntity> type, Level world) {
		super(type, world);
		xpReward = 0;
		setNoAi(false);
	...
	protected void defineSynchedData() {
		...
		this.entityData.define(TEXTURE, "water_cannon");
	}
	...
	public void baseTick() {
		super.baseTick();
		WaterCannonOnEntityTickUpdateProcedure.execute(this);
