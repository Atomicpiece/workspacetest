...
public class FurnacePoweredGolemEntity extends Monster {

	public FurnacePoweredGolemEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(WorkspaceTestModEntities.FURNACE_POWERED_GOLEM.get(), world);
	}

	public FurnacePoweredGolemEntity(EntityType<FurnacePoweredGolemEntity> type, Level world) {
		super(type, world);
		setMaxUpStep(0.6f);
		xpReward = 0;
		setNoAi(false);
	...
	public void playStepSound(BlockPos pos, BlockState blockIn) {
		this.playSound(ForgeRegistries.SOUND_EVENTS.getValue(new ResourceLocation("block.blastfurnace.fire_crackle")), 0.15f, 1);
	}
