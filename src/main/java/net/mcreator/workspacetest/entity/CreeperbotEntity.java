...
public class CreeperbotEntity extends IronGolem implements GeoEntity {
	...
	public CreeperbotEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(WorkspaceTestModEntities.CREEPERBOT.get(), world);
	}

	public CreeperbotEntity(EntityType<CreeperbotEntity> type, Level world) {
		super(type, world);
		xpReward = 0;
		setNoAi(false);
	...
	protected void defineSynchedData() {
		...
		this.entityData.define(TEXTURE, "robocreper");
	}
	...
	public SoundEvent getAmbientSound() {
		return ForgeRegistries.SOUND_EVENTS.getValue(new ResourceLocation("entity.parrot.imitate.creeper"));
	}

	@Override
	public void playStepSound(BlockPos pos, BlockState blockIn) {
		this.playSound(ForgeRegistries.SOUND_EVENTS.getValue(new ResourceLocation("block.calcite.step")), 0.15f, 1);
	}
	...
	protected void tickDeath() {
		...
		if (this.deathTime == 30) {
			this.remove(CreeperbotEntity.RemovalReason.KILLED);
			this.dropExperience();
