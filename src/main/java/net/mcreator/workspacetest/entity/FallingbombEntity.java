...
import net.mcreator.workspacetest.procedures.FallingbombWhileProjectileFlyingTickProcedure;
...
public class FallingbombEntity extends AbstractArrow implements ItemSupplier {
	...
	public void tick() {
		super.tick();
		FallingbombWhileProjectileFlyingTickProcedure.execute(this.level(), this.getX(), this.getY(), this.getZ());
		if (this.inGround)
			this.discard();
	}
