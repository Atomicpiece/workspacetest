...
import net.mcreator.workspacetest.procedures.RedstoneVoltWhileProjectileFlyingTickProcedure;
import net.mcreator.workspacetest.procedures.RedstoneVoltProjectileHitsLivingEntityProcedure;
import net.mcreator.workspacetest.procedures.RedstoneVoltProjectileHitsBlockProcedure;
...
public class RedstoneVoltEntity extends AbstractArrow implements ItemSupplier {
	...
	public void onHitEntity(EntityHitResult entityHitResult) {
		...
		RedstoneVoltProjectileHitsLivingEntityProcedure.execute(this.level(), this.getX(), this.getY(), this.getZ(), entityHitResult.getEntity(), this.getOwner());
	}
