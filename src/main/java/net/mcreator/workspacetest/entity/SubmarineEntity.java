...
public class SubmarineEntity extends Monster implements RangedAttackMob, GeoEntity {
	...
	public SubmarineEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(WorkspaceTestModEntities.SUBMARINE.get(), world);
	}

	public SubmarineEntity(EntityType<SubmarineEntity> type, Level world) {
		super(type, world);
		xpReward = 0;
		setNoAi(false);
			...
			public void tick() {
				...
				if (this.operation == MoveControl.Operation.MOVE_TO && !SubmarineEntity.this.getNavigation().isDone()) {
					...
					if (SubmarineEntity.this.isInWater()) {
						...
						SubmarineEntity.this.setSpeed(f1 * 0.05F);
					}
				} else {
					SubmarineEntity.this.setSpeed(0);
					SubmarineEntity.this.setYya(0);
					SubmarineEntity.this.setZza(0);
				}
			}
		};
	}
	...
	protected void defineSynchedData() {
		...
		this.entityData.define(TEXTURE, "submarine");
	}
	...
	public class RangedAttackGoal extends Goal {
		...
		public void stop() {
			...
			this.seeTime = 0;
			this.attackTime = -1;
			((SubmarineEntity) rangedAttackMob).entityData.set(SHOOT, false);
		}
		...
		public void tick() {
			...
			if (--this.attackTime == 0) {
				...
				((SubmarineEntity) rangedAttackMob).entityData.set(SHOOT, true);
	...
	public SoundEvent getAmbientSound() {
		return ForgeRegistries.SOUND_EVENTS.getValue(new ResourceLocation("block.bubble_column.bubble_pop"));
	}

	@Override
	public void playStepSound(BlockPos pos, BlockState blockIn) {
		this.playSound(ForgeRegistries.SOUND_EVENTS.getValue(new ResourceLocation("block.water.ambient")), 0.15f, 1);
	}
	...
	public void baseTick() {
		super.baseTick();
		SubmarineOnEntityTickUpdateProcedure.execute(this);
