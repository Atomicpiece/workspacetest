...
import net.mcreator.workspacetest.procedures.FoamWhileProjectileFlyingTickProcedure;
import net.mcreator.workspacetest.procedures.FoamProjectileHitsLivingEntityProcedure;
import net.mcreator.workspacetest.procedures.FoamProjectileHitsBlockProcedure;
...
public class FoamEntity extends AbstractArrow implements ItemSupplier {
	...
	public void onHitBlock(BlockHitResult blockHitResult) {
		...
		FoamProjectileHitsBlockProcedure.execute(this.level(), blockHitResult.getBlockPos().getX(), blockHitResult.getBlockPos().getY(), blockHitResult.getBlockPos().getZ());
	}
